...
public class AddProduct extends javax.swing.JDialog {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(txtNamaItem, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(103, 103, 103)
                        .addComponent(btnSimpan, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(id_produk.isEmpty() || nama_produk.isEmpty()){
            ...
            List<ProductItemTransient> q = new ArrayList<>();
            List<ProductItemStatic> r = new ArrayList<>();
            List<ProductItemFinal> s = new ArrayList<>();
            for(int i = 0; i < row; i++){
            ...
            ProductItemTransient qi = new ProductItemTransient(item_name, price);
            ProductItemStatic ri = new ProductItemStatic(item_name, price);
            ProductItemFinal si = new ProductItemFinal(item_name, price);
            p.add(pi);
            q.add(qi);
            r.add(ri);
            s.add(si);
        ...
        MainForm.product1 = new ProductTransient();
        MainForm.product3 = new ProductFinal(nama_produk, id_produk,s);
        
        MainForm.product.setNama(nama_produk);
        MainForm.product.setId(id_produk);
        MainForm.product.setItems(p);
        
        MainForm.product1.setNama(nama_produk);
        MainForm.product1.setId(id_produk);
        MainForm.product1.setItems(q);
        
        MainForm.product2.setNama(nama_produk);
        MainForm.product2.setId(id_produk);
        MainForm.product2.setItems(r);
